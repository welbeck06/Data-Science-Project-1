...
We plan to use multiple linear regression. This technique will help us model the relationship between the dependent variable which in this case is price and multiple independent variables (Power, Engine, Kilometers_Driven, Years_Used, etc). 

The multiple linear regression model could be expressed in the below equation:
$Y = β_0+β_1*X_1+β_2*X_2...β_n*X_n+\epsilon$ 
